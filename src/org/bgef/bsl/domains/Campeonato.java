 ...
 * @author duarteduarte
 */
public class Campeonato extends DomainPojo {
    ...
    public Campeonato(String nome, int epoca, List<Equipa> equipas, int estado, int mostrar, int idEscalao, Escalao escalao) {
        this.nome = nome;
        this.epoca = epoca;
